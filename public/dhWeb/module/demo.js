...
function clickStartTrafficDataQuery() {
  ...
  var handle = WebVideoCtrl.startTrafficDataQuery(
    sIP,
    0,
    startTime,
    endTime,
...
function clickStartRecordSearch() {
  ...
  var handle = WebVideoCtrl.startRecordInfoSearch(
    sIP,
    iChannel,
    iStreamType,
    szStartTime,
...
function clickSearchRecordStatus() {
  ...
  var sStatus = WebVideoCtrl.queryRecordFileBitmap(
    sIP,
    iChannel,
    year,
    month,
